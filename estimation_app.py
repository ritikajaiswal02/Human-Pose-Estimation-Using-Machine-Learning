...
BODY_PARTS = { "Nose": 0, "Neck": 1, "RShoulder": 2, "RElbow": 3, "RWrist": 4, ILShoulder": 5, "LElbow": 6, "LWrist": 7, "RHip": 8, "RKnee": 9,
"RAnkle": 10, "LHip": 11, "LKnee": 12, "LAnkle": 13, "REye": 14, "LEye": 15, "REar": 16, "LEar": 17, "Background": 18 }
...
def poseDetector(frame):
	...
	for pair in POSE_PAIRS:
		...
		if points[idFrom] and points[idTo]:
			...
			cv2.ellipse(frame, points[idFrom],(3,3), 0 , 0, 360 ,(0,0,255),cv2.FILLED)					cv2.ellipse(frame, points[idTo],(3,3), 0 , 0, 360 ,(0,0,255),cv2.FILLED)
...
st.image(output, caption="Pose Estimated Image", use_column_width=True)
st.markdown('''
	     #
	    ''')
